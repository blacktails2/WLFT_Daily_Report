...
export function PageTitle({ title }: { title: string }) {
  return (
    <div
      className="page-title-text fixed bottom-20 right-4 md:bottom-6 md:right-6 text-[28px] sm:text-[36px] md:text-[44px] lg:text-[54px] text-[var(--color-accent)] pointer-events-none select-none"
      style={{
        zIndex: -1,
